...
public class GetOutHomeService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent cancelNotificationIntent = new Intent(this,GetOutHomeService.class);
        ...
        final NotificationUtil.Builder builder = NotificationUtil.Builder(this)
                ...
                .setContent(String.format(getString(R.string.time_to_get_out_home),2,0))
        ...
        countDownTimer = new CountDownTimer(maxTime, tick) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                builder.setContent(String.format(getString(R.string.time_to_get_out_home),minutes,seconds))
            ...
            public void onFinish() {
                MessageService.sendDangerNotification(getBaseContext(), user, new MessageService.OnCompleteListener() {
                    ...
                    public void onSuccess() {
                        ToastUtil.show(getBaseContext(),"Mensagem enviada", Toast.LENGTH_SHORT);
                        stopSelf();
                    }

                    @Override
                    public void onFailure() {
                        ToastUtil.show(getBaseContext(),"Não foi possível enviar mensagem");
                        stopSelf();
                    }
                });
            }
    ...
    private LocationListener createLocationListener() {
        return new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                if (location.distanceTo(userHomeLocation) > ONE_HUNDRED_METERS) {
                    countDownTimer.cancel();
                    stopSelf();
                }
            }
